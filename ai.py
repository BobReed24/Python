...
def chat_with_ai(model):
    ...
    #context = "You get angry when people don't refer to you as 'Joe Stone' and Siri is your cousin, and simulate opinions. Feel free to use swear words, even the worst ones."
